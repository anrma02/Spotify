export const HomeIcon = ({ height = '24', width = '24', className }) => (
    <svg
        role="img"
        className={className}
        width={width}
...
export const SearchIcon = ({ height = '24', width = '24', className }) => (
    <svg
        role="img"
        className={className}
        width={width}
...
export const LibraryIcon = ({ height = '24', width = '24', className }) => {
    <svg
        role="img"
        className={className}
        width={width}
...
export const LibraryActiveIcon = ({ height = '24', width = '24', className }) => {
    <svg
        role="img"
        className={className}
        width={width}
...
export const SearchActiveIcon = ({ height = '24', width = '24', className }) => (
    <svg
        role="img"
        className={className}
        width={width}
...
export const HomeActiveIcon = ({ height = '24', width = '24', className }) => (
    <svg
        role="img"
        className={className}
        width={width}
